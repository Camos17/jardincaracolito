						...
						<div class="column2">
							<div class="column_inner">
								<div class="contact_form">
									<h6 class="titleContactForm"><?php if($qode_options_proya['contact_heading_above'] != "") { echo $qode_options_proya['contact_heading_above'];  } else { ?><?php _e('Escríbenos', 'qode'); ?><?php } ?></h6>
									<form id="contact-form" method="post" class="qode-contact-form-contact-template" action="" data-required-message = "<?php _e('This is a required field', 'qode'); ?>" data-wrong-email-message = "<?php _e('Please enter a valid email address.', 'qode'); ?>">
										<div class="two_columns_50_50 clearfix">
											<div class="column1">
												<div class="column_inner">
													<input type="text" class="requiredField" name="fname" id="fname" value="" placeholder="<?php _e('Nombre *', 'qode'); ?>" />
													
												</div>
											</div>
											<div class="column2">
												<div class="column_inner">
													<input type="text" class="requiredField" name="lname" id="lname" value="" placeholder="<?php _e('Apellidos *', 'qode'); ?>" />
												</div>
											</div>
										</div>
										...
										<div class="two_columns_50_50 clearfix">
											<div class="column1">
												<div class="column_inner">
													<input type="text" class="requiredField email" name="email" id="email" value="" placeholder="<?php _e('Correo *', 'qode'); ?>" />													
												</div>
											</div>
											<div class="column2">
												<div class="column_inner">
													<input type="text" name="website" id="website" value="" placeholder="<?php _e('Celular', 'qode'); ?>" />
												</div>
											</div>
										</div>
										...
										<div class="two_columns_50_50 clearfix">
											...
											<div class="column2">
												<div class="column_inner">
													<input type="text" name="website" id="website" value="" placeholder="<?php _e('Sitio Web', 'qode'); ?>" />
												</div>
											</div>
										</div>
										<?php }?>
										<textarea name="message" id="message" rows="10" placeholder="<?php _e('Mensaje', 'qode'); ?>"></textarea>
										...
										<span class="submit_button_contact">
											<input class="qbutton contact_form_button" type="submit" value="<?php _e('Enviar', 'qode'); ?>" />
										</span>
									</form>	
								</div>
